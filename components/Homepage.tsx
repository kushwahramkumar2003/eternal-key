...
const structuredData = {
  ...
  operatingSystem: "Web",
  description:
    "A decentralized dead man's switch for crypto inheritance on Solana, ensuring your digital assets reach your loved ones.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
          ...
          <div className="relative z-10 text-center space-y-16 p-8 max-w-6xl mx-auto">
            ...
            <div className="pt-16 border-t border-zinc-900">
              <div className="flex flex-wrap justify-center text-zinc-500 text-sm">
                <a
                  href="https://twitter.com/ramkumar_9301"
